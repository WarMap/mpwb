...
#import "MPNewFeatureCell.h"
@interface MPNewFeatureController()
@property (nonatomic, weak) UIPageControl *control;

@end
@implementation MPNewFeatureController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[MPNewFeatureCell class] forCellWithReuseIdentifier:ID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 3.没有注册，报错
    MPNewFeatureCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
